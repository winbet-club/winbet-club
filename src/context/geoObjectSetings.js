...
exports.geoObjectSetings = [
    {
        geometry: {
            coordinates: exports.mapState.coordinates[0],
            type: "Point"
        },
        id: 0,
    ...
    {
        geometry: {
            coordinates: exports.mapState.coordinates[1],
            type: "Point"
        },
        id: 1,
        modules: ["geoObject.addon.balloon", "geoObject.addon.hint"],
    ...
    {
        geometry: {
            coordinates: exports.mapState.coordinates[2],
            type: "Point"
        },
        id: 1,
        modules: ["geoObject.addon.balloon", "geoObject.addon.hint"],
    ...
    {
        geometry: {
            coordinates: exports.mapState.coordinates[3],
            type: "Point"
        },
        id: 1,
        modules: ["geoObject.addon.balloon", "geoObject.addon.hint"],
